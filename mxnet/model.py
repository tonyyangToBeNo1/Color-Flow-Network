    ...
    for epoch in range(begin_epoch, end_epoch):
        ...
        while True:
            ...
            for data_batch in train_data:
                ...
                gt = executor_manager.get_params()[0]['gt313']
                #print gt.asnumpy().shape
                executor_manager.update_metric(eval_metric, gt)
        ...
        if eval_data:
            ...
            for i, eval_batch in enumerate(eval_data):
                ...
                # change by tzy *********************************************
                # in this case, we do not have label so we replace the label with gt313
                # the gt313 is the actually label but we have to get it from the network
